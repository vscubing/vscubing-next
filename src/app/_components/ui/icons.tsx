...
const SvgPlaceholder = (props: ComponentProps<"svg">) => <svg {...props} />;

export {
  SvgPlaceholder as AllContestsIcon,
  SvgPlaceholder as ArrowBackUpIcon,
  SvgPlaceholder as ArrowRightIcon,
  SvgPlaceholder as AvatarIcon,
  SvgPlaceholder as CheckIcon,
  SvgPlaceholder as CloseIcon,
  SvgPlaceholder as DashboardIcon,
  SvgPlaceholder as DiscordIcon,
  SvgPlaceholder as ExclamationCircleIcon,
  SvgPlaceholder as GoogleIcon,
  SvgPlaceholder as GithubIcon,
  SvgPlaceholder as LeaderboardIcon,
  SvgPlaceholder as ChevronLeftIcon,
  SvgPlaceholder as ChevronUpIcon,
  SvgPlaceholder as ChevronDownIcon,
  SvgPlaceholder as LinkedinIcon,
  SvgPlaceholder as LogoutIcon,
  SvgPlaceholder as MenuIcon,
  SvgPlaceholder as OngoingContestIcon,
  SvgPlaceholder as PlayForwardIcon,
  SvgPlaceholder as PlayIcon,
  SvgPlaceholder as PlaySkipBackIcon,
  SvgPlaceholder as PlaySkipForwardIcon,
  SvgPlaceholder as PlaybackIcon,
  SvgPlaceholder as ChevronRightIcon,
  SvgPlaceholder as ShareIcon,
  SvgPlaceholder as SortIcon,
  SvgPlaceholder as StopIcon,
  SvgPlaceholder as EllipsisIcon,
  SvgPlaceholder as PlusIcon,
  SvgPlaceholder as MinusIcon,
  SvgPlaceholder as SettingIcon,
};
